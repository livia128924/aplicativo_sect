      ...
      <View style={styles.form_}>
        ...
        <View style={{ alignSelf: "center", width: "85%" }}>
          <DropDownPicker
            ...
            listMode="SCROLLVIEW"
            onChangeValue={() =>
              onPressTitle("se_ruf", "se_ruf_municipio", valor, sync)
            }
        ...
        <View style={{ alignSelf: "center", width: "85%" }}>
          <DropDownPicker
            ...
            onChangeValue={() =>
              onPressTitle("se_ruf", "se_ruf_acesso", valorAcesso, sync)
            }
            listMode="SCROLLVIEW"
            placeholder="acesso"
          />
        ...
        <View style={{ alignItems: "center" }}>
          <TextInput
            ...
            value={localizacao}
            onBlur={() =>
              onPressTitle("se_ruf", "se_ruf_localizacao", localizacao, sync)
            }
